...
public class EmployeeSalary {
	...
	public static void main(String[] args) {
		...
		try{
			...
			System.out.println("Das ist keine richtige Kommazahl");
		}catch (Exception e){
		...
		if(hourlySalary < 0)
			System.out.println("The Hourly Salary must be postive");
		...
		if(weeklyTime < 0)
			System.out.println("The weekly time must be postive");
